        ...
        <div className="flex flex-1 w-full h-full me-3 gap-3 font-inter">
          <div className="md:flex xs:hidden sm:hidden hidden flex-[0.2] flex-col">
            <div className="flex w-full h-[60vh] bg-[rgb(17,29,39)] rounded-xl flex-col mx-3 overflow-hidden p-4">
             ...
             uppercase flex justify-center items-center rounded-full"
                >
                  {user?.name[0]}
                </div>
              )) || (
              ...
              <article className="text-center">
                ...
                <p className="text-gray-200 text-sm my-4 p-3">
                  ...
                  Advices, Education, etc. But avoid to share personal
                  information.
                </p>
                {isLoggedIn && (
                  <button
                    onClick={clearChat}
                    className="w-[200px] my-auto font-[700] rounded mx-auto bg-red-500 border-none
               uppercase text-white px-4 py-2 text-sm hover:bg-red-800"
                  >
                    Delete Conversation
                  </button>
                )}
          ...
          <div className="flex flex-1 md:flex-[0.8] mx:flex-1 sm:flex-1 flex-col p-4">
           ...
           overflow-y-auto smooth bg-white/10 shadow-inner"
            >
              {!isLoggedIn ? (
                <Link
                  className="w-[200px] my-auto font-[700] rounded mx-auto bg-green-500 border-none
               uppercase text-white px-4 py-2 text-sm hover:bg-green-800 flex items-center justify-center"
                  href="/login"
                >
                  Log in to chat!
                </Link>
            ...
            <div className="mt-5 w-full p-5 rounded bg-[rgb(17,27,39)] flex m-auto items-center">
              <textarea
                ...
                className="resize-y w-full bg-transparent p-4 border-none text-white focus:bg-black
               hover:bg-black outline-none focus:outline-none "
              />
              <BiSend
            ...
            <button
              onClick={clearChat}
              className="w-[200px] md:hidden mt-8 font-[500] rounded mx-auto bg-red-600 border-none
             uppercase text-white text-xs py-1"
            >
              Delete Conversation
            </button>
          </div>
